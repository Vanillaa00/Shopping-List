...
class ShopItemViewModel: ViewModel() {
    ...
    private val _isCloseActivity = MutableLiveData<Unit>()
    val isCloseActivity : LiveData<Unit>
        get() = _isCloseActivity
